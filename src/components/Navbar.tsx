      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a className="text-nordic-dark/70 hover:text-nordic-dark dark:text-gray-400 dark:hover:text-white font-medium text-sm hover:border-b-2 hover:border-nordic-dark/20 dark:hover:border-white/20 px-1 py-1 transition-all" href="#">Rent</a>
            <a className="text-nordic-dark/70 hover:text-nordic-dark dark:text-gray-400 dark:hover:text-white font-medium text-sm hover:border-b-2 hover:border-nordic-dark/20 dark:hover:border-white/20 px-1 py-1 transition-all" href="#">Sell</a>
            <a className="text-nordic-dark/70 hover:text-nordic-dark dark:text-gray-400 dark:hover:text-white font-medium text-sm hover:border-b-2 hover:border-nordic-dark/20 dark:hover:border-white/20 px-1 py-1 transition-all" href="#">Saved Homes</a>
          </div>
